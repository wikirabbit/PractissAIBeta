...
(function () {
  ...
  // --------------------------------------------------------------------
    ...
    if (document.querySelector('.wizard-numbered') != null) {
  ...
  // Vertical Wizard
    // --------------------------------------------------------------------
    if (document.querySelector('.wizard-vertical') != null) {
  ...
  // Modern Wizard
    // --------------------------------------------------------------------
    if (document.querySelector('.wizard-modern-example') != null) {
  ...
  // Modern Vertical Wizard
    ...
    if (document.querySelector('.wizard-modern-vertical') != null) {
